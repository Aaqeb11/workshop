...
const TicketPage = () => {
  ...
  return (
    <main className="bg-white relative z-30">
      <section className="mt-12 py-24 jutify-center text-center">
      <h2 className="text-3xl md:text-4xl font-bold">
          Do You Have Any Questions?
        </h2>
        <p className="text-base md:text-lg mt-2">
          If you have any additional questions about the workshop and what's included,
          book a call with our team using the button below.
        </p>
        <button className="mt-4 px-6 py-2 border-2 border-[#63AB38] bg-[#63AB38] text-white rounded-2xl hover:bg-white hover:text-[#63AB38] hover:border-[#63AB38] hover:duration-500">
          Book A Call
        </button>
        </section>
      <div className="flex items-center justify-center p-4 min-h-screen bg-white pt-20 md:pt-20 gap-6 flex-col md:flex-row">
      
        {/* First Ticket */}
        <Card className="w-full max-w-[90vw] md:max-w-[70vw] lg:max-w-[30vw] flex flex-col items-center bg-gradient-to-br from-[#4CAF50] to-[#3E3E3E] gap-2 rounded-3xl ring-4 ring-[#449E10] shadow-lg transition-transform transform md:hover:scale-105 duration-300 shadow-white/50 overflow-y-auto max-h-[90vh] md:max-h-[100vh]">
          <CardHeader className="flex flex-col gap-4 items-center w-full p-4">
            <Image src="/ticket.png" alt="learn" width={50} height={50} />
            <p className="text-xl md:text-2xl text-white">IN-PERSON Ticket</p>
            <p className="text-sm md:text-base text-white">20 spots Available</p>
