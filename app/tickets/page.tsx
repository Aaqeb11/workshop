...
>
  ...
  <div className="text-center md:text-left">
    ...
    We’re excited to welcome you to the Gold Mining Workshop community! Stay tuned for some amazing updates—keep an eye on your inbox for important emails and news about the workshop. We’ve got some valuable insights and opportunities coming your way!
    </p>
  </div>
  ...
  <div className="flex md:text-left flex-col md:w-full gap-4 text-black">
    ...
    <div className="flex items-center gap-2">
      ...
      <p className="text-base text-gray-700">+1-623-343-2688</p>
    </div>
    ...
    <div className="flex items-center gap-2">
      ...
      <p className="text-base text-gray-700">info@thekevinchoe.com</p>
    </div>
  </div>
</div>

        <Card className="w-full max-w-[90vw] md:max-w-[70vw] lg:max-w-[30vw] flex flex-col items-center bg-gradient-to-br from-[#4CAF50] to-[#3E3E3E] gap-2 rounded-3xl ring-4 ring-[#449E10] shadow-lg transition-transform transform md:hover:scale-105 duration-300 shadow-white/50 overflow-y-auto  min-h-screen ">
